  ...
  render(){
    return (
      ...
      <View style={{flex:1,backgroundColor: 'black'}}> 
       ...
       <View style={{flex: 1}}>
       <TouchableOpacity style={{flexDirection: 'row',borderBottomColor:'black',borderBottomWidth:1}}>
       ...
       <View style={{flexDirection: 'row', }}>
          <TouchableOpacity style={{flex: 1,height:60,justifyContent:'center',padding:1,margin:20,backgroundColor: 'black'}}
          onPress={()=>this.masukanAngka('(')}>
          
            <Text style ={{color:'#1E90FF',fontSize:24,textAlign:'center'}}>(</Text>
          </TouchableOpacity>
          <TouchableOpacity style={{flex: 1,height:60,justifyContent:'center',padding:1,margin:20,backgroundColor: 'black'}}
          onPress={()=>this.masukanAngka(')')}
          >
        ...
        <View style={{flexDirection: 'row', }}>
          ...
          <TouchableOpacity style={{flex: 1,height:60,justifyContent:'center',padding:1,margin:20,backgroundColor: 'black'}}
          onPress={()=>this.masukanAngka('*')}>
            <Text style ={{color:'#1E90FF',fontSize:24,textAlign:'center'}}>x</Text>
          </TouchableOpacity>
        </View>
        <View style={{flexDirection: 'row', }}>
          <TouchableOpacity style={{flex: 1,height:60,justifyContent:'center',padding:1,margin:20,backgroundColor: 'black'}}
